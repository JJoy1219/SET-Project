		...
		xhr.onreadystatechange = function()
		{
			if (this.readyState == 4 && this.status == 200)
			{
				...
				for( var i=0; i<jsonObject.results.length; i++ )
				{
					...
					contactList += '<button button type="button" onclick="deleteConfirm(' + temp + ');">Delete '  //Changed onclick from deleteContact to deleteConfirm to process press OK calls deleteContact else do nothing.
...
function deleteConfirm(deleteID)  //New function created 06/07
